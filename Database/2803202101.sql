...
GO
/****** Object:  Table [dbo].[AdminTbl]    Script Date: 28-03-2021 13:38:16 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[AnswersTbl]    Script Date: 28-03-2021 13:38:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AppointmentsTbl]    Script Date: 28-03-2021 13:38:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CredentialTbl]    Script Date: 28-03-2021 13:38:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[QuestionTbl]    Script Date: 28-03-2021 13:38:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RoleTbl]    Script Date: 28-03-2021 13:38:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[StudentTbl]    Script Date: 28-03-2021 13:38:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[StudyMaterialTbl]    Script Date: 28-03-2021 13:38:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SubjectTbl]    Script Date: 28-03-2021 13:38:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TeachersStudentTbl]    Script Date: 28-03-2021 13:38:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TeacherTbl]    Script Date: 28-03-2021 13:38:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[CredentialTbl] ([CredID], [RoleID], [Email], [Password], [IsEmailverify], [IsPhoneVerify], [PasswordResetCode], [EmailVerificationCode], [PhoneVerificationCode], [EnteredOn], [UpdatedOn]) VALUES (4, 2, N'student@gmail.com', N'password', 0, 0, NULL, NULL, NULL, CAST(N'2021-03-03T12:28:22.710' AS DateTime), CAST(N'2021-03-03T12:28:22.710' AS DateTime))
GO
INSERT [dbo].[CredentialTbl] ([CredID], [RoleID], [Email], [Password], [IsEmailverify], [IsPhoneVerify], [PasswordResetCode], [EmailVerificationCode], [PhoneVerificationCode], [EnteredOn], [UpdatedOn]) VALUES (5, 3, N'teacher@gmail.com', N'password', 0, 0, NULL, NULL, NULL, CAST(N'2021-03-03T12:28:55.760' AS DateTime), CAST(N'2021-03-03T12:28:55.760' AS DateTime))
GO
...
GO
SET IDENTITY_INSERT [dbo].[TeachersStudentTbl] ON 
GO
INSERT [dbo].[TeachersStudentTbl] ([TeachersStudentId], [StudentId], [TeacherId], [IsApprove]) VALUES (1, 2, 1, 0)
GO
SET IDENTITY_INSERT [dbo].[TeachersStudentTbl] OFF
GO
SET IDENTITY_INSERT [dbo].[TeacherTbl] ON 
GO
INSERT [dbo].[TeacherTbl] ([TeacherID], [CredID], [FullName], [Location], [EnterdOn], [UpdatedOn], [Gender], [Phone], [DOB], [IsOffline], [OfflineTime], [IsOnline], [OnlineTime], [Days], [DemoClassURL]) VALUES (1, 5, N'Test Teacher', N'Nilamel', CAST(N'2021-03-03T13:10:35.523' AS DateTime), CAST(N'2021-03-03T13:10:35.523' AS DateTime), N'Male', N'9539391527', NULL, 1, N'10 AM to 12 AM', 0, N'0', N'Monday Only', N'https://www.youtube.com/embed/QTI2MU_cAns')
GO
...
GO
ALTER TABLE [dbo].[TeachersStudentTbl]  WITH CHECK ADD  CONSTRAINT [FK_TeachersStudentTbl_StudentTbl] FOREIGN KEY([StudentId])
REFERENCES [dbo].[StudentTbl] ([StudentID])
GO
ALTER TABLE [dbo].[TeachersStudentTbl] CHECK CONSTRAINT [FK_TeachersStudentTbl_StudentTbl]
GO
ALTER TABLE [dbo].[TeachersStudentTbl]  WITH CHECK ADD  CONSTRAINT [FK_TeachersStudentTbl_TeacherTbl] FOREIGN KEY([TeacherId])
REFERENCES [dbo].[TeacherTbl] ([TeacherID])
GO
ALTER TABLE [dbo].[TeachersStudentTbl] CHECK CONSTRAINT [FK_TeachersStudentTbl_TeacherTbl]
GO
