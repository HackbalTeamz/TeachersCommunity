...
namespace TeachersCommunity
{
    public class BundleConfig
    {
        ...
        {
            string ltecomponents = "~/Scripts/AdminPanel/components/";
            string lteplugins = "~/Scripts/AdminPanel/plugins/";
            string lte = "~/Scripts/AdminPanel/";
            ...
            bundles.Add(new StyleBundle("~/Content/css")
                ...
                .Include("~/Content/AdminPanel/css/AdminLTE.min.css")
                .Include("~/Content/AdminPanel/css/skins/skin-purple.min.css")
